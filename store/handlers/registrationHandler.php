...
if (isset($_POST['register_user'])) {
    ...
    if (count($errors) == 0) {
        ...
        $query = "INSERT INTO `users` ( `admin`, `username`, `email`, `password`, `firstname`, `lastname`, `middlename`, `nickname`, `address1`, `address2`, `city`, `state`, `zipcode`) 
  			  VALUES(0, '$username', '$email', '$password', '$firstname', '$lastname', '$middlename', '$nickname', '$address1', '$address2', '$city', '$state', '$zipcode')";
